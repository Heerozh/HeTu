...
def test_system_clusters(test_component):
    ...
    assert clusters.get_system('system4', namespace='pytest').full_non_trx == {comp2, }
...
def test_system_copy(test_component):
    ...
    assert system_copy1_def.full_non_trx == {
